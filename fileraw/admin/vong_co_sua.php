...
<head>
  ...
  <title>Kuu Accessories | Quản trị vòng cổ </title>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Dữ liệu | <a href="vong_co_them_moi.php"> Thêm mới </a> </h1>
            </div>
            <div class="col-sm-6">
      ...
      <div id="layoutSidenav_content">
        <main>
          <div class="container-fluid px-4">
            <h1 class="mt-4">Quản trị vòng cổ  </h1>
            <ol class="breadcrumb mb-4">
              <li class="breadcrumb-item"><a href="quan_tri_san_pham.php">Quản trị sản phẩm </a></li>
              <li class="breadcrumb-item active">Quản trị vòng cổ  </li>
            </ol>
            <div class="card mb-4">
              <div class="card-header">
                <i class="fas fa-table me-1"></i>
                Danh sách vòng cổ  | <a href="vong_co_sua.php">Sửa </a>
              </div>
              <div class="card-body">
                <?php
                ...
                $sql = "
                          SELECT * 
                          FROM tbl_vong_co
                          WHERE vong_co_id  =".$vong_co_id." 
                          ORDER BY vong_co_id ASC";
                ...
                ;?>
                <form method="POST" action="vong_co_sua_thuc_hien.php" enctype="multipart/form-data">
                  <div class="form-floating mb-3">
                    <label for="txtTenVongCo">Tên vòng cổ </label>
                    <input class="form-control" id="txtTenVongCo" name="txtTenVongCo" placeholder="Tên vòng cổ " value="<?php echo $row['ten_vong_co'] ;?>" />
                  </div>
                  <div class="form-floating mb-3">
                  ...
                  <div class="mt-4 mb-0">
                    <input type="hidden" name="txtID" value="<?php echo $row['vong_co_id']; ?>">
