          ...
          <div class="container-fluid px-4">
            ...
            <div class="card mb-4">
              <div class="card-header">
                ...
                Danh sách vòng cổ   | <a href="vong_co_them_moi.php">Thêm mới </a>
              </div>
             <div class="card-body">
                  <form method="POST" action="vong_co_them_moi_thuc_hien.php" enctype="multipart/form-data">
                      <div class="form-floating mb-3">
                          <label for="txtTenVongCo">Tên vòng cổ  </label>
                          <input class="form-control" id="txtTenVongCo" name="txtTenVongCo" placeholder="Tên vòng cổ  " />
