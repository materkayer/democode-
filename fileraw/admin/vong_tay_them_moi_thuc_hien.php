        ...
        <?php         
         ...
         //   $anh_minh_hoa = $_POST["txtAnh"];
            ...
            if($anh_minh_hoa == NULL) {             
                   $sql = "
                  INSERT INTO `tbl_vong_tay` (`vong_tay_id`, `ten_vong_tay`,`anh_minh_hoa`,`gia_tien`) VALUES (NULL, '".$ten_vong_tay."', ''  ,'".$gia_tien."');                  ";
            } else {           
                 $sql = "
                          INSERT INTO `tbl_vong_tay` (`vong_tay_id`, `ten_vong_tay`, `anh_minh_hoa`, `gia_tien`) VALUES (NULL, '".$ten_vong_tay."', '".$anh_minh_hoa."', '".$gia_tien."')
                        ";           
            }
