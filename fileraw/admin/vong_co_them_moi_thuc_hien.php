        ...
        <?php         
         ...
         //   $anh_minh_hoa = $_POST["txtAnh"];
            ...
            if($anh_minh_hoa == NULL) {             
                   $sql = "
                  INSERT INTO `tbl_vong_co` (`vong_co_id`, `ten_vong_co`,`anh_minh_hoa`,`gia_tien`) VALUES (NULL, '".$ten_vong_co."', ''  ,'".$gia_tien."');                  ";
            } else {           
                 $sql = "
                          INSERT INTO `tbl_vong_co` (`vong_co_id`, `ten_vong_co`, `anh_minh_hoa`, `gia_tien`) VALUES (NULL, '".$ten_vong_co."', '".$anh_minh_hoa."', '".$gia_tien."')
                        ";           
            }
