          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Quản trị vòng cổ  </h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                  ...
                  <tbody>
                            ...
                            ;?>
                                <tr>
                                    ...
                                    <td><?php echo $row["ten_vong_co"];?></td>
                                    <td><?php echo $row["anh_minh_hoa"];?></td>
                                    <td><?php echo $row["gia_tien"];?></td>

                                    <td style="text-align: center;"><a href="vong_co_sua.php?id=<?php echo $row['vong_co_id'];?>">Sửa</a></td>
                                    <td style="text-align: center;"><a href="vong_co_xoa.php?id=<?php echo $row['vong_co_id'];?>">Xóa</a></td>
                                </tr>                                        
                            <?php 
                                }
