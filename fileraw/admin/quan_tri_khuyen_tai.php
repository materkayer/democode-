          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Quản trị khuyên tai  </h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                  ...
                  <tbody>
                            ...
                            ;?>
                                <tr>
                                    ...
                                    <td><?php echo $row["ten_khuyen_tai"];?></td>
                                    <td><?php echo $row["anh_minh_hoa"];?></td>
                                    <td><?php echo $row["gia_tien"];?></td>

                                    <td style="text-align: center;"><a href="khuyen_tai_sua.php?id=<?php echo $row['khuyen_tai_id'];?>">Sửa</a></td>
                                    <td style="text-align: center;"><a href="khuyen_tai_xoa.php?id=<?php echo $row['khuyen_tai_id'];?>">Xóa</a></td>
                                </tr>                                        
                            <?php 
                                }
