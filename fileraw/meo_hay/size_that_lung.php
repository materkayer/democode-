...
<head>
<title>Phụ kiện thời trang     Kuu Accessories</title>
<meta charset="utf-8">
    ...
    <header id="header" class="hoc clear">
      ...
      <nav id="mainav" class="fl_right"> 
        ...
        <ul class="clear">
          ...
          <li><a href="tin_tuc.php">Mẹo nhỏ</a></li>
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="content three_quarter first"> 
      <!-- ################################################################################################ -->
      <h1 style="font-family:Times New Roman">Cách đeo thắt lưng</h1>
      <img class="imgr borderedbox inspace-5" src="../images/meo_hay/15.png" style="width: 450px;" alt="">
      <p style="font-family:Times New Roman"><b>Đồng màu giữa thắt lưng và giày</b></p>
       <p>Nguyên tắc kinh điển nhất mà bạn không thể sai phạm trong cách phối hợp trang phục cho mình. Thắt lưng và giày luôn cần giống nhau về chất liệu và kiểu dáng nó mang lại hiệu ứng khá an toàn. Đối với những buổi tiệc có yêu cầu về trang phục da tiệc thì cánh mày râu càng không thể chọn sai loại thắc lưng để kết hợp.  Tuy nhiên, nếu bạn lúc nào cũng nguyên tắc cứng nhắc với cách phối đồ kiểu đó nó sẽ gây ra cảm giác nhàm chán, đôi khi bạn nên phá cạch phối màu tương phản giữa thắt lưng và chiếc calavat của bạn.</p> <br>

      <img class="imgl borderedbox inspace-5" src="../images/meo_hay/17.png" style="width: 300px;" alt="">
      <p style="font-family:Times New Roman"><b>Chọn thắt lưng có độ dài vừa phải</b></p>
      <p>Thắt lưng là phụ kiện thiết yếu của phái nam, thế nhưng không phải ai cũng biết chính xác thắt lưng dài bao nhiêu là vừa với cơ thể của mình.<br>

      Độ dài lý tưởng của một chiếc thắt lưng sau khi được thắt xong là đoạn thừa nằm gọn trong khoảng giữa của đỉa thứ 1 và thứ 2 của quần. Nếu phần đuôi quá dài thì đừng ngại ngần cắt bớt chúng đi.</p> 
            <p>Shop chỉ cho bạn 1 số tips để lựa chọn size thắt lưng phù hợp:</p>
            <p>Dựa vào kích thước quần để lựa chọn chiều dài thắt lưng là cách dễ dàng và cơ bản nhất mà bất cứ ai cũng thực hiện được.<br>

Nếu như bạn mặc size quần 30 thì hãy chọn thắt lưng có chiều dài 32 sẽ vừa vặn, tương tự quần 31 32 thì lựa chọn thắt lưng size 34…Tương tự như thế với các cỡ quần khác, chiều dài thắt lưng sẽ lớn hơn size quần khoảng 2 size là sẽ phù hợp.<br>

Với những loại thắt lưng có chiều dài là S-M-L thì kích thước sẽ tương ứng với 34-36-38. Tuy nhiên với các nhãn hiệu thì con số này không hoàn toàn là chính xác, tùy vào nhãn hiệu sẽ có sự chênh lệnh riêng.</p>


      <img class="imgr borderedbox inspace-5" src="../images/meo_hay/18.png" style="width: 350px;" alt="">
      <p style="font-family:Times New Roman"><b>Hạn chế chọn mặt thắt lưng hầm hố</b></p>
       <p>Đơn giản tạo nên sự tinh tế, lĩnh đạm. Hãy chọn cho mình kiểu khóa thắt lưng có hình chứ nhật hoặc bo tròn đầu với một chiếc cài khóa đơn giản cổ điển, lịch sự mà trang nhã</p> <br>
            <!-- ################################################################################################ -->
    </div>
    <!-- ################################################################################################ -->
    <!-- ################################################################################################ -->
    <div class="sidebar one_quarter"> 
      ...
      <nav class="sdb_holder">
        <ul>
          <li><a href="size_nhan.php">Cách đo size nhẫn</a></li>
          <li><a href="size_vong_tay.php">Cách đo size vòng tay</a></li>
          <li><a href="size_vong_co.php">Cách đo size vòng cổ</a></li>
          <li><a href="size_that_lung.php">Cách đeo thắt lưng</a></li>
          <li><a href="bao_quan.php">Cách bảo quản phụ kiện</a></li>
        </ul>
      </nav>
