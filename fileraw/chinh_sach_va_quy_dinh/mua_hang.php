...
<!-- End Facebook Pixel Code -->
              ...
              <h1 class="heading">Hướng dẫn mua hàng</h1>
              <ul class="nospace linklist">
                <li> <time pubdate datetime="2021-10-26">26/10/2021</time></li>
                <li>
<div class="fb-like" data-href="https://360boutique.vn/huong-dan-mua-hang/" data-layout="button_count" data-action="like" data-size="small" data-show-faces="true" data-share="true"></div>
                </li>
              </ul> 
              <ul class="nospace linklist">
        <li>
...
<p><strong>Cách thứ nhất: </strong>Gọi điện thoại đến số hotline nhân viên của công ty sẽ tư vấn và hỗ trợ cho khác hàng tất cả các thông tin về sản phẩm và dịch vụ..<br />
<strong><br />
Cách thứ hai: </strong>Đặt hàng qua website:<br />
Bước 1: Bấm vào nút “mua hàng” để đưa sản phẩm vào giỏ hàng sau khi đã lựa chọn sản phẩm mình muốn mua<br />
Bước 2: Sau khi chọn xong sản phẩm đặt mua, điền các thông tin theo yêu cầu của chúng tôi: size, màu sắc, số lượng ….<br />
Bước 3: Bấm nút “Gửi”<br />
Đơn hàng của bạn đã hoàn tất và được chuyển tới chúng tôi. Chúng tôi  sẽ xử lý và liên lạc lại với bạn để thực hiện giao dịch.</p>
                      </article>
        </li>
      </ul>              
            </div>
...
<h6 class="heading">Danh sách chi nhánh</h6>
    ...
    <div class="one_quarter">
      ...
      <ul class="nospace linklist">
        <li><a href="mua_hang.php">Hướng dẫn mua hàng</a></li>
        <li><a href="doi_tra_hang.php">Quy định về đổi trả hàng</a></li>
        <li><a href="bao_hanh.php">Chính sách bảo hành</a></li>
        <li><a href="mua_hang.php">Điều khoản dịch vụ</a></li>
        <li><a href="../#works">Giới thiệu</a></li>
      </ul>
    </div>
    <div class="one_quarter">
