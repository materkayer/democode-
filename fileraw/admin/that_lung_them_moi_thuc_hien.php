        ...
        <?php         
         ...
         //   $anh_minh_hoa = $_POST["txtAnh"];
            ...
            if($anh_minh_hoa == NULL) {             
                   $sql = "
                  INSERT INTO `tbl_that_lung` (`that_lung_id`, `ten_that_lung`,`anh_minh_hoa`,`gia_tien`) VALUES (NULL, '".$ten_that_lung."', ''  ,'".$gia_tien."');                  ";
            } else {           
                 $sql = "
                          INSERT INTO `tbl_that_lung` (`that_lung_id`, `ten_that_lung`, `anh_minh_hoa`, `gia_tien`) VALUES (NULL, '".$ten_that_lung."', '".$anh_minh_hoa."', '".$gia_tien."')
                        ";           
            }
