...
<head>
  ...
  <title>Kuu Accessories | Quản trị thắt lưng </title>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Dữ liệu | <a href="that_lung_them_moi.php"> Thêm mới </a> </h1>
            </div>
            <div class="col-sm-6">
      ...
      <div id="layoutSidenav_content">
        <main>
          <div class="container-fluid px-4">
            <h1 class="mt-4">Quản trị thắt lưng  </h1>
            <ol class="breadcrumb mb-4">
              <li class="breadcrumb-item"><a href="quan_tri_san_pham.php">Quản trị sản phẩm </a></li>
              <li class="breadcrumb-item active">Quản trị thắt lưng  </li>
            </ol>
            <div class="card mb-4">
              <div class="card-header">
                <i class="fas fa-table me-1"></i>
                Danh sách thắt lưng  | <a href="that_lung_sua.php">Sửa </a>
              </div>
              <div class="card-body">
                <?php
                ...
                $that_lung_id = $_GET["id"];
                $sql = "
                          SELECT * 
                          FROM tbl_that_lung 
                          WHERE that_lung_id  =".$that_lung_id." 
                          ORDER BY that_lung_id ASC";
                ...
                ;?>
                <form method="POST" action="that_lung_sua_thuc_hien.php" enctype="multipart/form-data">
                  <div class="form-floating mb-3">
                    <label for="txtTenThatLung">Tên thắt lưng </label>
                    <input class="form-control" id="txtTenThatLung" name="txtTenThatLung" placeholder="Tên thắt lưng " value="<?php echo $row['ten_that_lung'] ;?>" />
                  </div>
                  <div class="form-floating mb-3">
                  ...
                  <div class="mt-4 mb-0">
                    <input type="hidden" name="txtID" value="<?php echo $row['that_lung_id']; ?>">
