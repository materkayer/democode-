...
<head>
  ...
  <title>Kuu Accessories | Quản trị nhẫn  </title>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Dữ liệu | <a href="nhan_them_moi.php"> Thêm mới </a> </h1>
            </div>
            <div class="col-sm-6">
      ...
      <div id="layoutSidenav_content">
        <main>
          <div class="container-fluid px-4">
            <h1 class="mt-4">Quản trị nhẫn  </h1>
            <ol class="breadcrumb mb-4">
              <li class="breadcrumb-item"><a href="quan_tri_san_pham.php">Quản trị sản phẩm </a></li>
              <li class="breadcrumb-item active">Quản trị nhẫn  </li>
            </ol>
            <div class="card mb-4">
              <div class="card-header">
                <i class="fas fa-table me-1"></i>
                Danh sách nhẫn  | <a href="nhan_sua.php">Sửa </a>
              </div>
              <div class="card-body">
                <?php
                ...
                ;?>
                <form method="POST" action="nhan_sua_thuc_hien.php" enctype="multipart/form-data">
                  <div class="form-floating mb-3">
                    <label for="txtTenNhan">Tên nhẫn  </label>
                    <input class="form-control" id="txtTenNhan" name="txtTenNhan" placeholder="Tên nhẫn  " value="<?php echo $row['ten_nhan'] ;?>" />
                  </div>
                  <div class="form-floating mb-3">
                  ...
                  <div class="mt-4 mb-0">
                    <input type="hidden" name="txtID" value="<?php echo $row['nhan_id']; ?>">
