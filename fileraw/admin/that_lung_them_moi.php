        ...
        <main>
          <div class="container-fluid px-4">
            ...
            <div class="card mb-4">
             ...
             <div class="card-body">
                  <form method="POST" action="that_lung_them_moi_thuc_hien.php" enctype="multipart/form-data">
                      <div class="form-floating mb-3">
                          <label for="txtTenThatLung">Tên thắt lưng </label>
                          <input class="form-control" id="txtTenThatLung" name="txtTenThatLung" placeholder="Tên thắt lưng " />
