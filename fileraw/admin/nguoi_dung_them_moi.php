        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="./quan_tri_tin_tuc.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
...
<div class="card-body">
      <form method="POST" action="nguoi_dung_them_moi_thuc_hien.php" enctype="multipart/form-data">
          <div class="form-floating mb-3">
              ...
              <input class="form-control" id="txtHoTen" name="txtHoTen" placeholder="Họ tên " />
          ...
          <div class="form-floating mb-3">
              ...
              <input class="form-control" id="txtDiaChi" name="txtDiaChi" placeholder="Địa chỉ " />
          </div>
          <div class="form-floating mb-3">
              <label for="txtGhiChu">Ghi chú </label>
              <input class="form-control" id="txtGhiChu" name="txtGhiChu" placeholder="Ghi chú " />
