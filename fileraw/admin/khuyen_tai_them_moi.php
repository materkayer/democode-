          ...
          <div class="container-fluid px-4">
            ...
            <div class="card mb-4">
              <div class="card-header">
                ...
                Danh sách khuyên tai    | <a href="khuyen_tai_them_moi.php">Thêm mới </a>
              </div>
             <div class="card-body">
                  <form method="POST" action="khuyen_tai_them_moi_thuc_hien.php" enctype="multipart/form-data">
                      <div class="form-floating mb-3">
                          <label for="txtTenKhuyenTai">Tên vòng cổ  </label>
                          <input class="form-control" id="txtTenKhuyenTai" name="txtTenKhuyenTai" placeholder="Tên khuyên tai" />
