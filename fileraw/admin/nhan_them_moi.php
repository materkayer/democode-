          ...
          <div class="container-fluid px-4">
            ...
            <div class="card mb-4">
              <div class="card-header">
                ...
                Danh sách nhẫn  | <a href="nhan_them_moi.php">Thêm mới </a>
              </div>
             <div class="card-body">
                  <form method="POST" action="nhan_them_moi_thuc_hien.php" enctype="multipart/form-data">
                      <div class="form-floating mb-3">
                          <label for="txtTenNhan">Tên nhẫn   </label>
                          <input class="form-control" id="txtTenNhan=" name="txtTenNhan" placeholder="Tên nhẫn  " />
