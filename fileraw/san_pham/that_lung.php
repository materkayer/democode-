...
<div class="wrapper row3">
  ...
  <div class="hoc container clear"> 
    ...
    <div class="sectiontitle">
      <p class="nospace font-xs">Men's fashion accessories
</p>
      <p class="heading underline font-x2">Cowhide belt
</p>
    </div>
    <ul class="nospace group team">
     <?php
      ...
      <li style = "margin-right: 83px; margin-bottom: 8px; " class="one_quarter">
        <figure><a class="imgover" href="https://shopee.vn/Th%E1%BA%AFt-L%C6%B0ng-Da-Nam-Phong-C%C3%A1ch-H%C3%A0n-Qu%E1%BB%91c-JM-Kuu-Clothes-M%C3%A0u-%C4%90en-%C4%90%E1%BA%B9p-Cao-C%E1%BA%A5p-Tr%E1%BA%BB-Trung-D%C3%A2y-L%C6%B0ng-Nam-Ch%E1%BA%A5t-Li%E1%BB%87u-Da-Th%E1%BA%ADt-JM-i.176380499.7386687511?sp_atk=7535916f-10b9-44a6-b3b8-9fc19093ad49"><img src=" <?php echo $row['anh_minh_hoa'] ? '../images/demo/gallery/'.$row['anh_minh_hoa'] : '../images/demo/gallery/jm.jpg' ;?>" alt=""></a>
          <figcaption><strong><?php echo $row['gia_tien'];?></strong> <em><?php echo $row['ten_that_lung'];?></em></figcaption>
        </figure>
      </li>
...
<p class="heading" style="font-family:Arial; text-transform: none; font-style: italic; font-size: 15px">*Ấn vào hình ảnh để có thể  liên kết tới link shopee</p>

      <nav class="pagination">
        <ul>
         <li><a href="#">&laquo; Previous</a></li>
          <li class="current"><strong>1</strong></li>
          <li><a href="that_lung2.php">2</a></li>
          <li><a href="that_lung2.php">Next &raquo;</a></li>
        </ul>
      </nav>
      <!-- ################################################################################################ -->
    </div>
