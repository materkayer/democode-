        ...
        <?php         
         ...
         //   $anh_minh_hoa = $_POST["txtAnh"];
            ...
            if($anh_minh_hoa == NULL) {             
                   $sql = "
                  INSERT INTO `tbl_khuyen_tai` (`khuyen_tai_id`, `ten_khuyen_tai`,`anh_minh_hoa`,`gia_tien`) VALUES (NULL, '".$ten_khuyen_tai."', ''  ,'".$gia_tien."');                  ";
            } else {           
                 $sql = "
                          INSERT INTO `tbl_khuyen_tai` (`khuyen_tai_id`, `ten_khuyen_tai`, `anh_minh_hoa`, `gia_tien`) VALUES (NULL, '".$ten_khuyen_tai."', '".$anh_minh_hoa."', '".$gia_tien."')
                        ";           
            }
