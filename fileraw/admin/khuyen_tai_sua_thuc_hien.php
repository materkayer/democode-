  ...
  <link rel="stylesheet" href="../../dist/css/adminlte.min.css">
    ...
    <body class="sb-nav-fixed">
        <?php         
            ...
            $khuyen_tai_id  = $_POST["txtID"];
            $ten_khuyen_tai = $_POST["txtTenKhuyenTai"];
         ...
         //   $anh_minh_hoa = $_POST["txtAnh"];
            ...
            $noi_dat_file_anh_minh_hoa = "../images/demo/gallery/".basename($_FILES["txtAnh"]["name"]);
            ...
            if($anh_minh_hoa == NULL) {             
                   $sql = "
                  UPDATE `tbl_khuyen_tai` SET `ten_khuyen_tai` = '".$ten_khuyen_tai."',`gia_tien` = '".$gia_tien."' WHERE `tbl_khuyen_tai`.`khuyen_tai_id` ='".$khuyen_tai_id."' 
                  ";
            } else {           
                 $sql = "
                          UPDATE `tbl_khuyen_tai` SET `ten_khuyen_tai` = '".$ten_khuyen_tai."', `anh_minh_hoa` = '".$anh_minh_hoa."', `gia_tien` = '".$gia_tien."' WHERE `tbl_khuyen_tai`.`khuyen_tai_id` ='".$khuyen_tai_id."'
                        ";           
            }
          ...
          // 4. Thực thi câu lệnh truy vấn (mục đích trả về dữ liệu các bạn cần)
            ...
            echo "
                <script type='text/javascript'>
                    window.location.href='quan_tri_khuyen_tai.php';
                </script>
            ";
        ;?>
    </body>
