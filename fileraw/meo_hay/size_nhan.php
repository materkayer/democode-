...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="content three_quarter first"> 
      ...
      <img class="imgr borderedbox inspace-5" src="../images/meo_hay/07.png" alt="">
      <p>Dụng cụ cần chuẩn bị: 1 cái thước, 1 sợi dây hoặc 1 tờ giấy, 1 chiếc bút.<br></p>
      <p>Cách tiến hành: <br>
      B1: Cắt 1 mảnh giấy dài khoảng 15 cm và chiều rộng không quá 0,5 cm.<br>

B2: Quấn mảnh giấy xung quanh phần lớn nhất của ngón tay.<br>

B3: Dùng bút đánh dấu ở điểm mà mảnh giấy tạo thành 1 vòng tròn.<br>

B4: Đặt phẳng mảnh giấy và đo khoảng cách từ đầu đến điểm đánh dấu. ( Đó là chu vi vòng nhẫn của bạn)<br></p>
      <img class="imgl borderedbox inspace-5" src="../images/meo_hay/08.png" alt="">
      <p>Đây bảng kích thước size nhẫn chuẩn nhất</p>
      <p>* Lưu ý: <br>
