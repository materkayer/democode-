...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="content three_quarter first"> 
      <!-- ################################################################################################ -->
      <h1>Cách đo size vòng tay</h1>
      <img class="imgr borderedbox inspace-5" src="../images/meo_hay/09.png" style="width: 350px;" alt="">
      <p>Dụng cụ cần chuẩn bị: 1 cái thước, 1 sợi dây, 1 chiếc bút.<br></p>
      <p>Cách tiến hành: (trong trường hợp không có sẵn vòng tay để đo) <br>
      B1: Sử dụng 1 sợi dây dài khoảng 30cm.<br>

B2: Quấn sợi dây xung quanh cổ tay của bạn.<br>

B3: Dùng bút đánh dấu ở điểm mà sợi dây tạo thành 1 vòng tròn.<br>

B4: Đặt phẳng sợi dây và đo khoảng cách từ đầu đến điểm đánh dấu. ( Đó là chu vi cổ tay của bạn)<br></p>
      <img class="imgl borderedbox inspace-5" src="../images/meo_hay/11.png" style="width: 850px;" alt="">
      <p>Đây bảng kích thước size vòng tay chuẩn nhất</p>
      <p>* Lưu ý: <br>
      Cỡ tay của bạn có thể thay đổi tùy vào từng thời điểm trong ngày hoặc thời tiết. Ví dụ, cỡ tay vào buổi sáng có thể nhỏ hơn vì tay chưa ấm và thời tiết cũng lạnh hơn. Vào cuối ngày cỡ tay có thể lớn hơn do bạn hoạt động nhiều trong ngày.<br></p>
      <p>Chính vì vậy, bạn nên đo size tay khoảng 3-4 lần vào các thời điểm khác nhau trong ngày để có kết quả chính xác nhất. Nếu size nhẫn của bạn nằm giữa 2 số, bạn nên chọn số lớn hơn.</p>
      <p>Lưu ý: Cách này có độ chính xác ở mức tương đối.</p>
