  ...
  <link rel="stylesheet" href="../../dist/css/adminlte.min.css">
    ...
    <body class="sb-nav-fixed">
        <?php         
            ...
            $that_lung_id  = $_POST["txtID"];
            $ten_that_lung = $_POST["txtTenThatLung"];
         ...
         //   $anh_minh_hoa = $_POST["txtAnh"];
            ...
            if($anh_minh_hoa == NULL) {             
                   $sql = "
                  UPDATE `tbl_that_lung` SET `ten_that_lung` = '".$ten_that_lung."',`gia_tien` = '".$gia_tien."' WHERE `tbl_that_lung`.`that_lung_id` ='".$that_lung_id."' 
                  ";
            } else {           
                 $sql = "
                          UPDATE `tbl_that_lung` SET `ten_that_lung` = '".$ten_that_lung."', `anh_minh_hoa` = '".$anh_minh_hoa."', `gia_tien` = '".$gia_tien."' WHERE `tbl_that_lung`.`that_lung_id` ='".$that_lung_id."' 
                        ";           
            }
          ...
          // 4. Thực thi câu lệnh truy vấn (mục đích trả về dữ liệu các bạn cần)
            ...
            echo "
                <script type='text/javascript'>
                    window.location.href='quan_tri_that_lung.php';
                </script>
            ";
        ;?>
    </body>
