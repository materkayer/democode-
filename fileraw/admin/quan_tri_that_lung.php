          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Quản trị thắt lưng  </h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                  ...
                  <tbody>
                            ...
                            ;?>
                                <tr>
                                    ...
                                    <td><?php echo $row["ten_that_lung"];?></td>
                                    <td><?php echo $row["anh_minh_hoa"];?></td>
                                    <td><?php echo $row["gia_tien"];?></td>

                                    <td style="text-align: center;"><a href="that_lung_sua.php?id=<?php echo $row['that_lung_id'];?>">Sửa</a></td>
                                    <td style="text-align: center;"><a href="that_lung_xoa.php?id=<?php echo $row['that_lung_id'];?>">Xóa</a></td>
                                </tr>                                        
                            <?php 
                                }
