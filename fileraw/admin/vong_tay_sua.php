    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Dữ liệu | <a href="vong_tay_them_moi.php"> Thêm mới </a> </h1>
            </div>
            <div class="col-sm-6">
          ...
          <div class="container-fluid px-4">
            ...
            <div class="card mb-4">
              <div class="card-header">
                ...
                Danh sách vòng tay  | <a href="vong_tay_sua.php">Sửa </a>
              </div>
              <div class="card-body">
                <?php
                ...
                $sql = "
                          SELECT * 
                          FROM tbl_vong_tay
                          WHERE vong_tay_id  =".$vong_tay_id." 
                          ORDER BY vong_tay_id ASC";
                ...
                ;?>
                <form method="POST" action="vong_tay_sua_thuc_hien.php" enctype="multipart/form-data">
                  <div class="form-floating mb-3">
                    <label for="txtTenVongTay">Tên vòng cổ </label>
                    <input class="form-control" id="txtTenVongTay" name="txtTenVongTay" placeholder="Tên vòng tay " value="<?php echo $row['ten_vong_tay'] ;?>" />
                  </div>
                  <div class="form-floating mb-3">
                  ...
                  <div class="mt-4 mb-0">
                    <input type="hidden" name="txtID" value="<?php echo $row['vong_tay_id']; ?>">
