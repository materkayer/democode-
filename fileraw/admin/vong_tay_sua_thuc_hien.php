  ...
  <link rel="stylesheet" href="../../dist/css/adminlte.min.css">
    ...
    <body class="sb-nav-fixed">
        <?php         
            ...
            $vong_tay_id  = $_POST["txtID"];
            $ten_vong_tay = $_POST["txtTenVongTay"];
         ...
         //   $anh_minh_hoa = $_POST["txtAnh"];
            ...
            if($anh_minh_hoa == NULL) {             
                   $sql = "
                  UPDATE `tbl_vong_tay` SET `ten_vong_tay` = '".$ten_vong_tay."',`gia_tien` = '".$gia_tien."' WHERE `tbl_vong_tay`.`vong_tay_id` ='".$vong_tay_id."' 
                  ";
            } else {           
                 $sql = "
                          UPDATE `tbl_vong_tay` SET `ten_vong_tay` = '".$ten_vong_tay."', `anh_minh_hoa` = '".$anh_minh_hoa."', `gia_tien` = '".$gia_tien."' WHERE `tbl_vong_tay`.`vong_tay_id` ='".$vong_tay_id."'
                        ";           
            }
          ...
          // 4. Thực thi câu lệnh truy vấn (mục đích trả về dữ liệu các bạn cần)
            ...
            echo "
                <script type='text/javascript'>
                    window.location.href='quan_tri_vong_tay.php';
                </script>
            ";
        ;?>
    </body>
