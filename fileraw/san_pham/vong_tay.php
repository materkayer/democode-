...
<div class="wrapper row3">
  ...
  <div class="hoc container clear"> 
    ...
    <div class="sectiontitle">
      ...
      <p class="heading underline font-x2">Bracelet
</p>
    </div>
      ...
      <nav class="pagination">
        <ul>
         <li><a href="#">&laquo; Previous</a></li>
          ...
          <li><a href="vong_tay2.php">2</a></li>
          
          <li><a href="vong_tay2.php">Next &raquo;</a></li>
        </ul>
      </nav>
      <!-- ################################################################################################ -->
    </div>
