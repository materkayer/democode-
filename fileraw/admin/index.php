...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    // 1. Load file cấu hình để kết nối đến máy chủ CSDL, CSDL
                ...
                $so_luong_san_pham = mysqli_num_rows($noi_dung_khuyen_tai) + mysqli_num_rows($noi_dung_nhan) + mysqli_num_rows($noi_dung_that_lung) + mysqli_num_rows($noi_dung_vong_tay) + mysqli_num_rows($noi_dung_vong_co) ;
            ;?>
        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                <h3><?php echo $so_luong_nguoi_dung;?></h3>
              ...
              <a href="quan_tri_nguoi_dung.php" class="small-box-footer">Chi tiết  <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              <div class="inner">
                <h3><?php echo $so_luong_san_pham;?> </h3>
              ...
              <a href="quan_tri_san_pham.php" class="small-box-footer">Chi tiết <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
