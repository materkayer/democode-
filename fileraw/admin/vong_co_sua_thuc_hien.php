  ...
  <link rel="stylesheet" href="../../dist/css/adminlte.min.css">
    ...
    <body class="sb-nav-fixed">
        <?php         
            ...
            $vong_co_id  = $_POST["txtID"];
            $ten_vong_co = $_POST["txtTenVongCo"];
         ...
         //   $anh_minh_hoa = $_POST["txtAnh"];
            ...
            if($anh_minh_hoa == NULL) {             
                   $sql = "
                  UPDATE `tbl_vong_co` SET `ten_vong_co` = '".$ten_vong_co."',`gia_tien` = '".$gia_tien."' WHERE `tbl_vong_co`.`vong_co_id` ='".$vong_co_id."' 
                  ";
            } else {           
                 $sql = "
                          UPDATE `tbl_vong_co` SET `ten_vong_co` = '".$ten_vong_co."', `anh_minh_hoa` = '".$anh_minh_hoa."', `gia_tien` = '".$gia_tien."' WHERE `tbl_vong_co`.`vong_co_id` ='".$vong_co_id."'
                        ";           
            }
          ...
          // 4. Thực thi câu lệnh truy vấn (mục đích trả về dữ liệu các bạn cần)
            ...
            echo "
                <script type='text/javascript'>
                    window.location.href='quan_tri_vong_co.php';
                </script>
            ";
        ;?>
    </body>
