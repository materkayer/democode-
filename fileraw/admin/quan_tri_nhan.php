          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Quản trị nhẫn   </h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                  ...
                  <tbody>
                            ...
                            ;?>
                                <tr>
                                    ...
                                    <td><?php echo $row["ten_nhan"];?></td>
                                    <td><?php echo $row["anh_minh_hoa"];?></td>
                                    <td><?php echo $row["gia_tien"];?></td>

                                    <td style="text-align: center;"><a href="nhan_sua.php?id=<?php echo $row['nhan_id'];?>">Sửa</a></td>
                                    <td style="text-align: center;"><a href="nhan_xoa.php?id=<?php echo $row['nhan_id'];?>">Xóa</a></td>
                                </tr>                                        
                            <?php 
                                }
