<?php 
    ...
    # TH1: Nếu số lượng bản ghi = 0 --> email, password không chính xác --> đẩy người dùng về trang đăng nhập
    # TH2: Nếu số lượng bản ghi = 1 --> email, password chính xác --> đẩy người dùng về trang quản trị hệ thống
