...
<head>
  ...
  <title>Kuu Accessories | Quản trị khuyên tai  </title>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Dữ liệu | <a href="khuyen_tai_them_moi.php"> Thêm mới </a> </h1>
            </div>
            <div class="col-sm-6">
      ...
      <div id="layoutSidenav_content">
        <main>
          <div class="container-fluid px-4">
            <h1 class="mt-4">Quản trị khuyên tai  </h1>
            <ol class="breadcrumb mb-4">
              <li class="breadcrumb-item"><a href="quan_tri_san_pham.php">Quản trị sản phẩm </a></li>
              <li class="breadcrumb-item active">Quản trị khuyên tai  </li>
            </ol>
            <div class="card mb-4">
              <div class="card-header">
                <i class="fas fa-table me-1"></i>
                Danh sách khuyên tai  | <a href="khuyen_tai_sua.php">Sửa </a>
              </div>
              <div class="card-body">
                <?php
                ...
                $khuyen_tai_id = $_GET["id"];
                $sql = "
                          SELECT * 
                          FROM tbl_khuyen_tai
                          WHERE khuyen_tai_id  =".$khuyen_tai_id." 
                          ORDER BY khuyen_tai_id ASC";
                ...
                ;?>
                <form method="POST" action="khuyen_tai_sua_thuc_hien.php" enctype="multipart/form-data">
                  <div class="form-floating mb-3">
                    <label for="txtTenKhuyenTai">Tên khuyên tai  </label>
                    <input class="form-control" id="txtTenKhuyenTai" name="txtTenKhuyenTai" placeholder="Tên khuyên tai  " value="<?php echo $row['ten_khuyen_tai'] ;?>" />
                  </div>
                  <div class="form-floating mb-3">
                    <label for="txtAnh">Ảnh minh họa  </label>
                    <input type= "file" class="form-control" id="txtAnh" name="txtAnh" placeholder="Ảnh minh họa  " value="<?php echo $row['anh_minh_hoa'] ;?>" />
                  </div>
                  <div class="form-floating mb-3">
                    <label for="txtGiaTien">Giá tiền </label>
                    <input class="form-control" id="txtGiaTien" name="txtGiaTien" placeholder="Giá tiền " value="<?php echo $row['gia_tien'] ;?>" />

                  </div>
                  <div class="mt-4 mb-0">
                    <input type="hidden" name="txtID" value="<?php echo $row['khuyen_tai_id']; ?>">
