...
<div class="wrapper row3">
  ...
  <div class="hoc container clear"> 
    ...
    <div class="sectiontitle">
      ...
      <p class="heading underline font-x2">Earring
</p>
    </div>
    ...
    <?php
      ...
      <li style = "margin-right: 83px; margin-bottom: 10; " class="one_quarter ">
        <figure><a class="imgover" href="https://shopee.vn/Khuy%C3%AAn-Tai-Tr%C3%B2n-H%C3%ACnh-Ng%C3%B4i-Sao-Ch%E1%BB%AF-Th%E1%BA%ADp-Unisex-Gre-Earing-M%C3%A0u-B%E1%BA%A1c-%C4%90%E1%BA%B9p-C%C3%A1-T%C3%ADnh-Ch%E1%BA%A5t-Khuy%C3%AAn-Tai-Th%E1%BB%9Di-Trang-Kuu-Titan-i.176380499.7793834724?sp_atk=3c8cec41-e28d-42a4-a7a4-44adc649a052"><img src=" <?php echo $row['anh_minh_hoa'] ? '../images/demo/gallery/'.$row['anh_minh_hoa'] : '../images/demo/gallery/gre.jpg' ;?>" alt=""></a>
          <figcaption><strong><?php echo $row['gia_tien'];?></strong> <em><?php echo $row['ten_khuyen_tai'];?></em></figcaption>
        </figure>
      </li>
...
<p class="heading" style="font-family:Arial; text-transform: none; font-style: italic; font-size: 15px">*Ấn vào hình ảnh để có thể  liên kết tới link shopee</p>
      ...
      <nav class="pagination">
        <ul>
          ...
          <li><a href="khuyen_tai2.php">2</a></li>
          <li><a href="khuyen_tai2.php">Next &raquo;</a></li>
        </ul>
      </nav>
      <!-- ################################################################################################ -->
    </div>
