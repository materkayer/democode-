        ...
        <?php         
         ...
         //   $anh_minh_hoa = $_POST["txtAnh"];
            ...
            if($anh_minh_hoa == NULL) {             
                   $sql = "
                  INSERT INTO `tbl_nhan` (`nhan_id`, `ten_nhan`,`anh_minh_hoa`,`gia_tien`) VALUES (NULL, '".$ten_nhan."', ''  ,'".$gia_tien."');                  ";
            } else {           
                 $sql = "
                          INSERT INTO `tbl_nhan` (`nhan_id`, `ten_nhan`, `anh_minh_hoa`, `gia_tien`) VALUES (NULL, '".$ten_nhan."', '".$anh_minh_hoa."', '".$gia_tien."')
                        ";           
            }
