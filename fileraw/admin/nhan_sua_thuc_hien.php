        ...
        <?php         
         ...
         //   $anh_minh_hoa = $_POST["txtAnh"];
            ...
            if($anh_minh_hoa == NULL) {             
                   $sql = "
                  UPDATE `tbl_nhan` SET `ten_nhan` = '".$ten_nhan."',`gia_tien` = '".$gia_tien."' WHERE `tbl_nhan`.`nhan_id` ='".$nhan_id."' 
                  ";
            } else {           
                 $sql = "
                          UPDATE `tbl_nhan` SET `ten_nhan` = '".$ten_nhan."', `anh_minh_hoa` = '".$anh_minh_hoa."', `gia_tien` = '".$gia_tien."' WHERE `tbl_nhan`.`nhan_id` ='".$nhan_id."'
                        ";           
            }
          ...
          // 4. Thực thi câu lệnh truy vấn (mục đích trả về dữ liệu các bạn cần)
            ...
            echo "
                <script type='text/javascript'>
                    window.location.href='quan_tri_nhan.php';
                </script>
            ";
        ;?>
    </body>
